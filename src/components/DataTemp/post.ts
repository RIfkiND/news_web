...
> = {
  ...
  "robotics-in-manufacturing": {
    ...
    links: [
      { label: "Robotics Business Review", href: "https://www.roboticsbusinessreview.com/" },
      { label: "IFR: Robotics Statistics", href: "https://ifr.org/worldrobotics/" }
    ],
    content: [
  ...
  "cloud-computing-growth": {
    ...
    links: [
      ...
      { label: "Google Cloud News", href: "https://cloud.google.com/blog/products/gcp" }
    ],
    content: [
  ...
  "ai-art-creativity": {
    ...
    links: [
      ...
      { label: "MIT Technology Review: AI Art", href: "https://www.technologyreview.com/topic/artificial-intelligence/" }
    ],
    content: [
  ...
  "cybersecurity-threats-2025": {
    ...
    links: [
      ...
      { label: "Cybersecurity & Infrastructure Security Agency", href: "https://www.cisa.gov/" }
    ],
    content: [
  ...
  "space-exploration-advances": {
    ...
    links: [
      { label: "NASA News", href: "https://www.nasa.gov/news/releases/latest/index.html" },
